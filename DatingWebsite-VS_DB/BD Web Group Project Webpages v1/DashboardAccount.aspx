...
<asp:Content ID="Content1" ContentPlaceHolderID="cphDashboardMain" runat="server">
    ...
    <!-- This page is for the user to update their Account Details 
        ...
        <div class="detailsBox">
            ...
            <asp:TextBox ID="txtEmail" runat="server" class="loginTextBox" ValidationGroup="vgUpdateEmail" ></asp:TextBox>
            ...
            <asp:TextBox ID="txtNewEmail" runat="server" class="loginTextBox" ValidationGroup="vgUpdateEmail" ></asp:TextBox>
            ...
            <br />
            <br />
            <asp:Button ID="btnUpdateEmail" runat="server" Text="Update Email" ValidationGroup="vgUpdateEmail" class="blueButton dashboardButton"/>
            <br />
            <br />
        </div>
        <br />
        ...
        <div class="detailsBox">
            ...
            <asp:TextBox ID="txtCurrentPwd" runat="server" class="loginTextBox" ValidationGroup="vgUpdatePwd" ></asp:TextBox>
            ...
            <asp:TextBox ID="txtNewPwd" runat="server" class="loginTextBox" ValidationGroup="vgUpdatePwd" ></asp:TextBox>
            ...
            <asp:TextBox ID="txtConfirmPwd" runat="server" class="loginTextBox" ValidationGroup="vgUpdatePwd" ></asp:TextBox>
            ...
            <br />
            <br />
            <asp:Button ID="btnUpdatePwd" runat="server" Text="Set New Password" ValidationGroup="vgUpdatePwd" class="blueButton dashboardButton"/>
            <br />
            <br />
        </div>
